...
namespace TentIo.Client
{
    public class TentClient
    {
        ...
        private async static Task<string> GetApiPath(string serverName)
        {
        ...
        public async Task<List<Post>> GetPosts()
        {
            ...
            string postsUrl = ServerUri("posts");
            ...
            var posts = await response.Content.ReadAsAsync<List<Post>>(new List<MediaTypeFormatter>() { new TentJsonMediaTypeFormatter() });
            return posts;
        }
